...
import { Category, ContentItem, CATEGORY_COLORS, DEFAULT_CATEGORIES } from '../types';
import NeoCard from '../components/ui/NeoCard';
import { Code2, PenTool, Layout, Gamepad2, BrainCircuit, Wrench, Folder, Image as ImageIcon, FileText, Hash } from 'lucide-react';
...
const CategoriesView: React.FC<CategoriesViewProps> = ({ items, selectedCategory, onSelectCategory }) => {
  ...
  const categories = useMemo(() => {
    const defaultCats = [
      { id: DEFAULT_CATEGORIES.FULL_STACK, icon: Code2, desc: "Frontend, Backend, DBs", gridClass: "md:col-span-2 md:row-span-2" },
      { id: DEFAULT_CATEGORIES.UI_UX, icon: Layout, desc: "Figma, Wireframes, User Research", gridClass: "" },
      { id: DEFAULT_CATEGORIES.DESIGN, icon: PenTool, desc: "Graphic Design, Trends, Art", gridClass: "md:row-span-2" },
      { id: DEFAULT_CATEGORIES.GAME_DEV, icon: Gamepad2, desc: "Unity, Unreal, C#", gridClass: "" },
      { id: DEFAULT_CATEGORIES.AI_ML, icon: BrainCircuit, desc: "LLMs, Python, Data Science", gridClass: "md:col-span-2" },
      { id: DEFAULT_CATEGORIES.TOOLS, icon: Wrench, desc: "VS Code, Notion, Productivity", gridClass: "" },
      { id: DEFAULT_CATEGORIES.SCREENSHOTS, icon: ImageIcon, desc: "Visual inspiration", gridClass: "" },
      { id: DEFAULT_CATEGORIES.NOTES, icon: FileText, desc: "Docs & reminders", gridClass: "" },
      { id: DEFAULT_CATEGORIES.OTHER, icon: Folder, desc: "Everything else", gridClass: "" },
    ];
