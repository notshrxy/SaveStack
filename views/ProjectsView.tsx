                        ...
                        <div className="p-6 flex flex-col flex-grow relative z-10">
                          ...
                          <div className={`mt-auto pt-4 border-t-4 border-black flex justify-between items-center`}>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button onClick={(e) => { e.stopPropagation(); onRequestDelete(item); }} className="p-1.5 border-2 border-black bg-red-500 text-white shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] active:shadow-none active:translate-x-[1px] active:translate-y-[1px]">
